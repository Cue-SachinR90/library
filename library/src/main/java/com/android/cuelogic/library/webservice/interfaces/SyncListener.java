...
import com.android.cuelogic.library.webservice.OkHttpResponseDetails;
...
public interface SyncListener extends ProgressListener{
     ...
     */
    void  onSyncSuccess(OkHttpResponseDetails responseResult, int webServiceId);
     ...
     */
    void onSyncFailure(Object result, int webServiceId, String errorMessage);

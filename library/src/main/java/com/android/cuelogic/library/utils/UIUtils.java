package com.android.cuelogic.library.utils;
...
import com.android.cuelogic.library.R;
import com.android.cuelogic.library.constants.Constants;
...
public class UIUtils {
    ...
    public static void showLoader(final String strMessage, final Context currentContext) {
        try {
            ...
            removeLoader.postDelayed(rRemoveLoader, Constants.MAX_REQUEST_TIMEOUT_MS);
            int[] colorArray =
                    {
